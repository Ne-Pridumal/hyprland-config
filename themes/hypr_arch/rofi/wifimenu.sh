...
display-menu () {
	...
	case $launcher in
		...
		"rofi")
			case $form in
				1) rofi -theme ~/.config/hypr/themes/hypr_arch/rofi/wifi.rasi -dmenu -i -p "$prompt" ;;
				2) rofi -theme ~/.config/hypr/themes/hypr_arch/rofi/wifi.rasi -dmenu -p "$prompt" ;;
				3) rofi -theme ~/.config/hypr/themes/hypr_arch/rofi/wifi.rasi -dmenu -password -p "$prompt" ;;
			esac
			;;
		"wmenu")
			case $form in
